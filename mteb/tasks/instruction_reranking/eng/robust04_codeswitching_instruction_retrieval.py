...
class Robust04InstructionRetrievalCodeSwitching(AbsTaskRetrieval):
    """
    Robust04 Instruction Retrieval Code-Switching 变体任务
    ...
    metadata = TaskMetadata(
        name="Robust04InstructionRetrievalCodeSwitching",
        description="Robust04 Instruction Retrieval Code-Switching variant. Measuring retrieval instruction following ability on Robust04 narratives for the FollowIR benchmark.",
...
""",
    ...
    def __init__(self, query_file: str = None, instruction_file: str = None, **kwargs):
        ...
        Args:
            query_file: 本地 queries jsonl 文件路径。如果为 None，则从环境变量 ROBUST04_QUERY_FILE 获取
            instruction_file: 本地instructions jsonl 文件路径，如果为None, 则从环境变量 ROBUST04_INSTRUCTION_FILE 获取
        """
        super().__init__(**kwargs)
        self.query_file = query_file or os.getenv("ROBUST04_QUERY_FILE")
        self.instruction_file = instruction_file or os.getenv("ROBUST04_INSTRUCTION_FILE")
    ...
    def load_data(self, **kwargs):
        ...
        if not self.query_file:
            raise ValueError(
                ...
                "Please pass query_file parameter or set ROBUST04_QUERY_FILE environment variable."
            )
